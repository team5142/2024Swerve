...
public class Controller extends Joystick {
    ...
    public static final String LEFTJOYSTICK = null;
    ControllerDevice cd;
    ...
    public double getLeftStickY() {
        ...
        switch(cdt){
            ...
            case XBOX:
                ...
                break;
            case LEFTJOYSTICK:  // Assuming the Y-axis of the left joystick corresponds
    ...
    public double getLeftStickX() {
        ...
        switch(cdt){
            ...
            case XBOX:
                ...
                break;
            case LEFTJOYSTICK: // Assuming the X-axis of the left joystick corresponds
                rawX = this.getRawAxis(0);
                break;
            default:
                return 0; // Unknown controller type
    ...
    public double getLeftStickOmega() {
        ...
        switch(cdt){
            ...
            case XBOX:
                ...
                break;
            case RIGHTJOYSTICK: // Assuming the X-axis of the right joystick corresponds
